...
import com.proxu.app.extension.toLongEx
import com.proxu.app.handler.MmkvManager
import com.proxu.app.handler.SubscriptionUpdater
import com.proxu.app.helper.MmkvPreferenceDataStore
...
//            localDnsPort?.isEnabled = enabled
        ...
        private fun configureUpdateTask(interval: Long) {
            val rw = RemoteWorkManager.getInstance(ProxuApplication.application)
