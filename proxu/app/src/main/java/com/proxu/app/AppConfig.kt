...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/ch32v003-cloud/proxu"
    const val APP_API_URL = "https://api.github.com/repos/2dust/v2rayNG/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/ch32v003-cloud/proxu/master/CR.md"
    ...
    const val MSG_RELOAD_SERVER_LIST = 8

    /** Notification channel IDs and names. */
    const val RAY_NG_CHANNEL_ID = "RAY_NG_M_CH_ID"
    const val RAY_NG_CHANNEL_NAME = "proxu Background Service"
