...
import com.proxu.app.enums.NotificationChannelType
import com.proxu.app.util.LogUtil
import com.proxu.app.util.NotificationHelper
...
object SubscriptionUpdater {
     ...
     */
    fun sync(
        context: Context = ProxuApplication.application,
     ...
     */
    fun syncOne(context: Context = ProxuApplication.application, subId: String) {
     ...
     */
    fun cancelOne(context: Context = ProxuApplication.application, subId: String) {
